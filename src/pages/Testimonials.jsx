  ...
  return (
    <>
      ...
      <main className="pt-[90px] pb-20">
        ...
        <section
          id="testimonials"
          className="relative px-6 pt-12 pb-10 text-center lg:px-16"
        >
          <div className="mx-auto max-w-4xl">
            {/* Eyebrow Badge */}
            <p className="inline-block text-[11px] md:text-[12px] font-bold uppercase tracking-[2.4px] text-[#e9c349] mb-4">
              Verified Buyer Perspectives
            </p>

            {/* Main Headline */}
            <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-[54px] font-bold leading-[1.2] text-[#f8f7f4] tracking-[-0.01em]">
              Endorsed by Discerning Families &<br className="hidden sm:inline" />
              Global Investors
            </h1>

            {/* Subtitle */}
            <p className="mx-auto mt-5 max-w-2xl text-sm sm:text-base leading-relaxed text-[#9ca3af] font-normal">
              Real feedback from residents, expatriates, and investors across
              our completed and upcoming developments.
            </p>
          </div>

          {/* Trust Badges Strip */}
          <div className="mx-auto mt-12 max-w-5xl border-y border-[rgba(233,195,73,0.18)] bg-[rgba(18,22,34,0.4)] py-4.5 px-4 backdrop-blur-sm sm:rounded-none">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10 md:gap-14 text-xs md:text-sm font-medium text-[#d1d5db]">
              <div className="flex items-center gap-2.5">
                <i className="fa-solid fa-circle-check text-[#e9c349] text-base"></i>
                <span>100% On-Time Statutory Delivery</span>
              </div>

              <div className="hidden sm:block h-3.5 w-px bg-[rgba(233,195,73,0.2)]"></div>
        ...
        {/* TESTIMONIALS AUTOMATED SLIDING CAROUSEL */}
                ...
                <div className="glass-panel h-full flex flex-col justify-between rounded-2xl p-7 lg:p-8 hover:-translate-y-1 transition-all duration-300 border border-[rgba(233,195,73,0.22)] bg-[rgba(20,24,33,0.7)]">
                  <div>
                    ...
                    <p className="mt-3.5 text-[13.5px] leading-relaxed text-[#9ca3af] font-light italic">
                      “Purchasing our 3BHK residence from the UK was seamless.
                      Having clear non-mortgaged deeds, dedicated backup power,
                      and steady weekly photographic updates gave our family
                      complete serenity.”
                    </p>
                  </div>
                  ...
                  <div className="mt-8 border-t border-[rgba(255,255,255,0.06)] pt-4 flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-display text-sm font-bold text-[#f4f3ef]">
                        Dr. Roshan Perera
                      </h4>
                      <p className="text-[11px] text-[#868d9d] mt-0.5">
                        Consultant Physician (UK Diaspora)
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="testimonial-card-auto">
                <div className="glass-panel h-full flex flex-col justify-between rounded-2xl p-7 lg:p-8 hover:-translate-y-1 transition-all duration-300 border border-[rgba(233,195,73,0.22)] bg-[rgba(20,24,33,0.7)]">
                  <div>
                    ...
                    <p className="mt-3.5 text-[13.5px] leading-relaxed text-[#9ca3af] font-light italic">
                      “As an engineer, I inspected the foundation piling and
                      core concrete curing certificates personally. A&Y's
                      commitment to Grade-40 concrete and post-tensioned slabs
                      is evident in every square foot.”
                    </p>
                  </div>
                  ...
                  <div className="mt-8 border-t border-[rgba(255,255,255,0.06)] pt-4 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-[#868d9d] mt-0.5">
                        Chartered Structural Consultant (Colombo)
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="testimonial-card-auto">
                <div className="glass-panel h-full flex flex-col justify-between rounded-2xl p-7 lg:p-8 hover:-translate-y-1 transition-all duration-300 border border-[rgba(233,195,73,0.22)] bg-[rgba(20,24,33,0.7)]">
                  <div>
                    ...
                    <p className="mt-3.5 text-[13.5px] leading-relaxed text-[#9ca3af] font-light italic">
                      “Only 10 units in the entire building means no lobby
                      crowding, no elevator queues, and true neighborhood
                      tranquility just 2 minutes from Marine Drive. The finish
                  ...
                  <div className="mt-8 border-t border-[rgba(255,255,255,0.06)] pt-4 flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-display text-sm font-bold text-[#f4f3ef]">
                        Michael & Sarah de Silva
                      </h4>
                      <p className="text-[11px] text-[#868d9d] mt-0.5">
                        Technology Executives (Sydney Diaspora)
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="testimonial-card-auto">
                <div className="glass-panel h-full flex flex-col justify-between rounded-2xl p-7 lg:p-8 hover:-translate-y-1 transition-all duration-300 border border-[rgba(233,195,73,0.22)] bg-[rgba(20,24,33,0.7)]">
                  <div>
                    ...
                    <p className="mt-3.5 text-[13.5px] leading-relaxed text-[#9ca3af] font-light italic">
                      “In Sri Lanka's real estate market, legal transparency is
                      paramount. A&Y provided title clearance documents before
                      requesting a single rupee in reservation. Rare
                  ...
                  <div className="mt-8 border-t border-[rgba(255,255,255,0.06)] pt-4 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-[#868d9d] mt-0.5">
                        Senior Chartered Accountant (Colombo 03)
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="testimonial-card-auto">
                <div className="glass-panel h-full flex flex-col justify-between rounded-2xl p-7 lg:p-8 hover:-translate-y-1 transition-all duration-300 border border-[rgba(233,195,73,0.22)] bg-[rgba(20,24,33,0.7)]">
                  <div>
                    ...
                    <p className="mt-3.5 text-[13.5px] leading-relaxed text-[#9ca3af] font-light italic">
                      “Dual balconies catching the ocean breeze, German
                      acoustic glazing keeping street noise zero, and VRV
                      cooling make this residence peaceful. Handover was
                      executed precisely on time.”
                    </p>
                  </div>
              ...
              <div className="testimonial-card-auto">
                <div className="glass-panel h-full flex flex-col justify-between rounded-2xl p-7 lg:p-8 hover:-translate-y-1 transition-all duration-300 border border-[rgba(233,195,73,0.22)] bg-[rgba(20,24,33,0.7)]">
                  <div>
                    ...
                    <p className="mt-3.5 text-[13.5px] leading-relaxed text-[#9ca3af] font-light italic">
                      “My priority was elderly parent comfort: zero-step
                      elevator access and full automatic generator power for
                      every single AC unit and appliance. A&Y delivered
                      everything on contract.”
                    </p>
                  </div>
        ...
        <section className="px-6 pt-16 pb-12 lg:px-16">
          <div className="mx-auto max-w-[1240px]">
            <h2 className="font-display text-center text-2xl sm:text-3xl font-semibold text-[#f8f7f4] mb-10 tracking-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="video-card group cursor-pointer flex flex-col">
                <div className="relative aspect-[16/10] w-full overflow-hidden rounded-2xl border border-[rgba(233,195,73,0.15)] bg-gradient-to-br from-[#1b2130] to-[#0e121c] flex items-center justify-center shadow-lg transition-all duration-300 group-hover:border-[rgba(233,195,73,0.35)]">
                  <div className="absolute inset-0 opacity-20 bg-[radial-gradient(#e9c349_1px,transparent_1px)] [background-size:16px_16px]"></div>
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0c0f16]/80 via-transparent to-transparent"></div>

                  <div className="play-btn z-10 flex h-14 w-14 items-center justify-center rounded-2xl border border-[#e9c349] bg-[rgba(233,195,73,0.12)] text-[#e9c349] transition-all duration-300 backdrop-blur-sm">
                    <i className="fa-solid fa-play text-base translate-x-0.5"></i>
                  </div>
                </div>

                <p className="mt-3.5 text-center text-xs sm:text-[13px] font-medium text-[#c6c6cb] transition-colors duration-200 group-hover:text-[#e9c349]">
        ...
        <section className="px-6 pt-6 pb-8 lg:px-16">
          <div className="mx-auto max-w-[1240px]">
            <div className="relative overflow-hidden rounded-2xl border border-[rgba(233,195,73,0.22)] bg-gradient-to-r from-[#121622] via-[#151a29] to-[#121622] px-6 py-8 md:px-10 md:py-9 shadow-xl">
              <div className="absolute right-0 top-0 -mr-16 -mt-16 h-48 w-48 rounded-full bg-[rgba(233,195,73,0.06)] blur-3xl pointer-events-none"></div>

              <div className="relative flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
                <div>
                  <h3 className="font-display text-lg sm:text-xl md:text-2xl font-bold text-[#f8f7f4]">
      ...
      <div
        ...
        className={`fixed inset-0 z-50 items-center justify-center bg-black/80 p-4 backdrop-blur-sm ${
          isReviewModalOpen ? "flex" : "hidden"
        }`}
      >
        <div className="relative w-full max-w-lg rounded-2xl border border-[rgba(233,195,73,0.3)] bg-[#121622] p-6 sm:p-8 shadow-2xl">
          <button
            type="button"
            onClick={() => setIsReviewModalOpen(false)}
            title="Close review modal"
            aria-label="Close review modal"
            className="absolute right-5 top-5 text-gray-400 hover:text-white text-lg cursor-pointer"
          >
          ...
          <p className="mt-1 text-xs text-[#9ca3af]">
            Share your experience as an owner or investor with A&Y
            Consolidated.
          </p>
          ...
          <form onSubmit={handleReviewSubmit} className="mt-5 space-y-4">
            ...
            <div className="pt-2">
              <button
                type="submit"
                className="w-full rounded-xl bg-[#e9c349] py-3 text-xs font-bold uppercase tracking-wider text-[#1a1402] hover:bg-[#f3d368] transition-colors cursor-pointer"
              >
